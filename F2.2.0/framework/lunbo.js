    function Scroll(obj,speed,interval){    //父级容器，轮播速度，切换间隔
        $("."+obj).each(function(){
            ...
            $btnLi.click(function(){          //点击小圆点转到指定图片事件
...
//手机触摸效果
 ...
 document.getElementById("imgList").addEventListener("touchstart",touchStart,false);
